...
namespace API.Migrations
{
    ...
    [Migration("20240628132657_InitialCreate")]
            ...
            modelBuilder.Entity("API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2024, 6, 29, 10, 26, 55, 875, DateTimeKind.Local).AddTicks(3051),
                            Nome = "Trabalho"
                        },
                        new
                        {
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 6, 30, 10, 26, 55, 875, DateTimeKind.Local).AddTicks(3062),
                            Nome = "Estudos"
                        },
                        new
                        {
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 7, 1, 10, 26, 55, 875, DateTimeKind.Local).AddTicks(3067),
                            Nome = "Lazer"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Tarefa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd",
                            CriadoEm = new DateTime(2024, 7, 5, 10, 26, 55, 875, DateTimeKind.Local).AddTicks(3333),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 7, 1, 10, 26, 55, 875, DateTimeKind.Local).AddTicks(3341),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 7, 12, 10, 26, 55, 875, DateTimeKind.Local).AddTicks(3346),
